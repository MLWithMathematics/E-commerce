          ...
          {items.map(item => (
            <div key={item.id} className="card flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-bold text-[#f59e0b] mt-0.5">${parseFloat(item.price).toFixed(2)}</p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 rounded-xl p-4 text-sm">
            <div className="flex justify-between font-semibold">
              ...
              <span className="text-[#f59e0b]">${parseFloat(total).toFixed(2)}</span>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <button className="btn-accent flex-1 py-3" onClick={handlePlaceOrder} disabled={placing}>
              {placing ? 'Placing…' : `Pay $${parseFloat(total).toFixed(2)}`}
            </button>
          </div>
        </div>
      </Modal>
